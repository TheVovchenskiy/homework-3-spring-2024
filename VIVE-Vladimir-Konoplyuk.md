...
- по середине экрана кнопка `Создать лид-форму`
- если лид-формы до этого создавались, то есть список лид-форм
...
- снизу формы кнопки `Продолжить` и `Отмена`
  - при нажатии на кнопку `Продолжить` происходит валидация форм
    ...
    - в момент, когда ошибка исправлена, сообщение пропадает
    - при отсутствии ошибок пользователь переходит на следующий шаг создания лид-формы
  - при нажатии на кнопку `Отмена` окно закрывается и все внесенные изменения отменяются
- `Название лид-формы`:
  - по-умолчанию заполняется строкой `Лид-форма <дата>`
